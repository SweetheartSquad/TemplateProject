	...
	toonShader(new ComponentShaderBase(true))
{
	...
	diffuseShader->nodeName = "Scene: Surface Shaders, Shader: diffuse";
	...
	phongShader->nodeName = "Scene: Surface Shaders, Shader: phong";
	...
	blinnShader->nodeName = "Scene: Surface Shaders, Shader: blinn";
	...
	toonShader->nodeName = "Scene: Surface Shaders, Shader: toon";
